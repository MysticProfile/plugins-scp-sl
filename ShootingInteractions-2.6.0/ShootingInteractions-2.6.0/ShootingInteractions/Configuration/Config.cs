...
namespace ShootingInteractions.Configuration
{
...
#endif
    {
        ...
        [Description("Should shooting the Surface Gate A Bridge be handled like a valid target (disabling this will ignore it, preventing hitmarkers/interactions)")]
        public bool InteractWithSurfaceGateBridge { get; set; } = false;
        ...
        [Description("Should shooting a door button show a hitmarker")]
        public bool DoorButtonsShowHitMarker { get; set; } = false;

        [Description("Should shooting an elevator button show a hitmarker")]
        public bool ElevatorButtonsShowHitMarker { get; set; } = false;
